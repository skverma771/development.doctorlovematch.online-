...
class QuestionoptionsController extends Controller
{
    public function index()
    {
        ...
        return new QuestionoptionResource(Questionoption::with(['questionid'])->get());
    }
    ...
    public function show($id)
    {
        ...
        $questionoption = Questionoption::with(['questionid'])->findOrFail($id);
    ...
    public function store(StoreQuestionoptionsRequest $request)
    {
        ...
        $questionoption->questionid()->sync($request->input('questionid', []));
