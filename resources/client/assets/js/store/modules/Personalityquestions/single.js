function initialState() {
    return {
        item: {
            id: null,
            question: null,
            options_arr:[{"options":""},{"options":""},{"options":""},{"options":""}],
        },
...
// return false;
            axios.post('/api/v1/personalityquestions', params)
                .then(response => {
    ...
    updateData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post('/api/v1/personalityquestions/' + state.item.id, params)
                .then(response => {
    ...
    fetchData({ commit, dispatch }, id) {
        axios.get('/api/v1/personalityquestions/' + id)
            .then(response => {
                commit('setItem', response.data.data)
            })
