...
export default {
    ...
    methods: {
        ...mapActions('CountrydataSingle', ['storeData', 'resetState', 'setCode', 'setName', 'setContinent', 'setRegion', 'setSurfacearea', 'setIndepyear', 'setPopulation', 'setLifeexpectancy', 'setGnp', 'setGnpold', 'setLocalname', 'setGovernmentform', 'setHeadofstate', 'setCapital', 'setCode2']),
        updateCode(e) {
