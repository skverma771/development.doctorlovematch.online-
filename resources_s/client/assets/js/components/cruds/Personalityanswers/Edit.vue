...
export default {
    ...
    computed: {
        ...mapGetters('PersonalityanswersSingle', ['item', 'loading']),
    },
    created() {
    ...
    methods: {
        ...mapActions('PersonalityanswersSingle', ['fetchData', 'updateData', 'resetState', 'setUserid', 'setQuestionid', 'setOptionid', 'setCreated']),
        updateUserid(e) {
        ...
        submitForm() {
            this.updateData()
                .then(() => {
                    this.$router.push({ name: 'personalityanswers.index' })
