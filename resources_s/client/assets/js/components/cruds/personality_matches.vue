    ...
    <div class="container" style="padding-top: 50px !important;margin-bottom: 50px !important;"  >
        <div class="membars clearfix seekingMembars ">
                ...
                <div class="membarhead clearfix">
                    ...
                    <ol class="breadcrumb personality-tabs no-content  pull-left">
                        <li id='newquestions' @click="questions_div=true,matches_div=false">
                            <a :class="[questions_div ? 'active' : '' ]" style="cursor: pointer;">Update Assessments</a>
                        </li>
                        ...
                        <li  id='QuestionMatch' @click="check_status()">
                            <a :class="[matches_div ? 'active' : '' ]" style="cursor: pointer;">Personality Matches</a></li>
            ...
            <div class="col-md-12 padding0"  v-if="questions_div" id='questionslist'>
                <h2 class="matches_presonalityHead" id='assesmentId' v-if="question_filled>0">
                    You have completed the assessment</h2>
...
<!--           <ul>-->
<!--               <span class='persweight'>Do you like Books ?</span>-->
<!--                 <li>-->
<!--                  <label>-->
<!--                    <input type="radio" class= 'radiochek' autocomplete="off" checked="checked" name='radio_4'-->
<!--                           value='10'>-->
<!--                    Love books                  </label>-->
<!--                </li>-->
...
<!--                              <li>-->
<!--                  <label>-->
<!--                    <input type="radio" class= 'radiochek' autocomplete="off" name='radio_4' value='11'>-->
<!--                    Somewhat                  </label>-->
<!--                </li>-->
...
<!--                              <li>-->
<!--                  <label>-->
<!--                    <input type="radio" class= 'radiochek' autocomplete="off" name='radio_4' value='12'>-->
<!--                    Don’t like books                  </label>-->
<!--                </li>-->
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            ...
                            <div class="payment">
                                ...
                                <div class="text-para">
                                    <h3>3 Month Plan</h3> <p>Access to Personality Matches Only</p>

                                    <!--<a href="#payment_div">-->
                                    <button type="button" @click="fullplan=false,persplan=true,plan='pers',cost='2.97'" class="btn btn-danger Upgrade ">UPGRADE</button>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            axios.post('/api/personality_question' , params)
                .then(response => {
            ...
            axios.post('/api/v1/license')
                .then(response => {
                    if(JSON.parse(response.data.license).Personality || JSON.parse(response.data.license).Full){
                        this.license=false;
                    }
        ...
        methods: {
            ...
            submit_assessment(){
                ...
                if(this.questions.length>0){
                    ...
                    if(this.questions.length==return_arr.length){

                        let params=new FormData();
                        params.set('user_id',this.data_item.id);
                        params.set('answers',JSON.stringify(return_arr));
                        axios.post('/api/personality_answers' , params)
                            .then(response => {
            ...
            check_status(){
                ...
                if(this.question_filled!==0){
                    ...
                    alert('Please answer all Questions to see your Personality Matches');
                }
            },
            fetch_matches(){
                axios.post('/api/v1/license')
                    .then(response => {
                        // console.log(JSON.parse(response.data.license).Personality);
                        if(JSON.parse(response.data.license).Personality || JSON.parse(response.data.license).Full){

                            let params=new FormData();
                            params.set('id',this.data_item.id);
                            axios.post('/api/personality_match',params)
                                .then(response => {
