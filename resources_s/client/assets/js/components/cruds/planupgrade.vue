<template >
    <div class="container">
        ...
        <p class="upgrade-txt" style="margin-top: 30px">To have access to see your Personality Matches please Upgrade now!</p>
            ...
            <div class="col-sm-7">
                ...
                <div class="payment">
                    ...
                    <div class="text-para">
                        ...
                        <!--<a href="#payment_div">-->
                        <button type="button" class="btn btn-danger Upgrade ">UPGRADE</button>
                        <!--</a>-->
                    </div>
                </div>
