...
return [
	...
		'personalityquestions' => [		'title' => 'Personalityquestions',		'fields' => [			'question' => 'Question',		],	],
		'questionoptions' => [		'title' => 'Questionoptions',		'fields' => [			'questionid' => 'Questionid',			'options' => 'Options',		],	],
		'personalityoptions' => [		'title' => 'Personalityoptions',		'fields' => [			'questionid' => 'Questionid',			'options' => 'Options',		],	],
		'answers' => [		'title' => 'Answers',		'fields' => [			'userid' => 'Userid',			'questionid' => 'Questionid',			'optionid' => 'Optionid',			'created' => 'Created',		],	],
		'personalityanswers' => [		'title' => 'Personalityanswers',		'fields' => [			'userid' => 'Userid',			'questionid' => 'Questionid',			'optionid' => 'Optionid',			'created' => 'Created',		],	],
		'message' => [		'title' => 'Message',		'fields' => [			'msg-id' => 'Msg id',			'message' => 'Message',			'datetime' => 'Datetime',		],	],
		'messageconection' => [		'title' => 'Messageconection',		'fields' => [			'msg-id' => 'Msg id',			'sender-id' => 'Sender id',			'receiver-id' => 'Receiver id',			'notifystatus' => 'Notifystatus',			'notifycancelstatus' => 'Notifycancelstatus',			'paymentstatus' => 'Paymentstatus',			'readstatus' => 'Readstatus',		],	],
		'messagedelete' => [		'title' => 'Messagedelete',		'fields' => [			'from-user-id' => 'From user id',			'to-id' => 'To id',			'msg-id' => 'Msg id',			'status' => 'Status',			'datetime' => 'Datetime',		],	],
		'messageblock' => [		'title' => 'Messageblock',		'fields' => [			'user-id' => 'User id',			'member-id' => 'Member id',			'isblock' => 'Isblock',			'isspamorreport' => 'Isspamorreport',		],	],
		'whoviewme' => [		'title' => 'Whoviewme',		'fields' => [			'userid' => 'Userid',			'memberid' => 'Memberid',			'notifystatus' => 'Notifystatus',			'notifycancelstatus' => 'Notifycancelstatus',			'datetime' => 'Datetime',		],	],
		'usercommeetrequest' => [		'title' => 'Usercommeetrequest',		'fields' => [			'userid' => 'Userid',			'memberid' => 'Memberid',			'userrequest' => 'Userrequest',			'userresponse' => 'Userresponse',			'datetime' => 'Datetime',		],	],
		'usergroupmap' => [		'title' => 'Usergroupmap',		'fields' => [			'user-id' => 'User id',			'group-id' => 'Group id',		],	],
		'groupsmembers' => [		'title' => 'Groupsmembers',		'fields' => [			'groupid' => 'Groupid',			'memberid' => 'Memberid',			'approved' => 'Approved',			'requestrecbyid' => 'Requestrecbyid',			'created' => 'Created',		],	],
		'usersession' => [		'title' => 'Usersession',		'fields' => [			'userid' => 'Userid',			'username' => 'Username',			'userstatus' => 'Userstatus',			'created' => 'Created',		],	],
		'redirectlinks' => [		'title' => 'Redirectlinks',		'fields' => [			'old-url' => 'Old url',			'new-url' => 'New url',			'referer' => 'Referer',			'comment' => 'Comment',			'hits' => 'Hits',			'published' => 'Published',			'created-date' => 'Created date',			'modified-date' => 'Modified date',			'header' => 'Header',		],	],
		'weeklyhits' => [		'title' => 'Weeklyhits',		'fields' => [			'hits' => 'Hits',			'created' => 'Created',		],	],
		'astrologycalcsign' => [		'title' => 'Astrologycalcsign',		'fields' => [			'signfrom' => 'Signfrom',			'signto' => 'Signto',			'description' => 'Description',		],	],
		'payments' => [		'title' => 'Payments',		'fields' => [			'user-id' => 'User id',			'first-name' => 'First name',			'last-name' => 'Last name',			'zipcode' => 'Zipcode',			'country' => 'Country',			'payment-status' => 'Payment status',			'txn-id' => 'Txn id',			'txn-type' => 'Txn type',			'payer-email' => 'Payer email',			'payment-gross' => 'Payment gross',			'created' => 'Created',		],	],
		'userspaymentsplan' => [		'title' => 'Userspaymentsplan',		'fields' => [			'user-id' => 'User id',			'payment-id' => 'Payment id',			'plan-id' => 'Plan id',			'plan-date' => 'Plan date',			'expire-date' => 'Expire date',		],	],
		'blockusers' => [		'title' => 'Blockusers',		'fields' => [			'user-id' => 'User id',			'block-user-id' => 'Block user id',			'status' => 'Status',			'created' => 'Created',		],	],
		'subscriptionplan' => [		'title' => 'Subscriptionplan',		'fields' => [			'plan-name' => 'Plan name',			'plan-amount' => 'Plan amount',		],	],
		'astrologycalc' => [		'title' => 'Astrologycalc',		'fields' => [			'zodiac' => 'Zodiac',			'daterange' => 'Daterange',			'zodiac-images' => 'Zodiac images',		],	],
