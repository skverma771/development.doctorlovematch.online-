...
<header id="header" class="navbar-fixed-top padBtm0"> <!--  -->
            ...
            @guest
                <div class="pull-sm-right">
                    <div class="login-text-wrapper mr-25" style="margin-left: 5px">
                        <button type="button" onclick="document.getElementById('id01').style.display='block'" class="btn btn-default bluebtn">LOGIN</button>
                        <p>Are you an existing user?</p>
                    </div>
                    <div class="login-text-wrapper">
                        <button type="button" onclick="document.getElementById('id02').style.display='block'" class="btn btn-default bluebtn">REGISTER</button>
    ...
    <div id="id01" class="modal">
        ...
        <form class="modal-content animate login_model"  action="{{ url('login') }}" method="post" >
...
document.getElementById('id01').style.display='none'">password?</a></span>
    ...
    <div id="id03" class="modal">
        ...
        <form class="modal-content animate login_model"  action="{{ url('password/email') }}" method="post" >
